...
export default function Navbar() {
  return (
    <nav class="navbar navbar-expand-lg bg-white shadow-sm p fixed">
      <div class="container navbar-container py-3 px-4">
        <a class="navbar-brand" href="#">
          {/* <img src={logo}></img> */}
          <svg className="navbar-logo mt-auto" xmlns="http://www.w3.org/2000/svg" width="139" height="20">
            <defs>
              <linearGradient
                id="a"
                x1="72.195%"
        ...
        <button
          class="navbar-toggler nav-hamburger mb-auto"
          type="button"
        ...
        <button
          className="request-btn nav-request text-white py-2 me-5"
          type="button"
        >
          Request Invite
        </button>
